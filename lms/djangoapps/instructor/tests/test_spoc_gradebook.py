...
class TestLetterCutoffPolicy(TestGradebook):
    ...
    def test_styles(self):
        ...
        self.assertIn(u"grade_B {color:Chocolate;}", self.response.content)
        self.assertIn(u"grade_C {color:DarkSlateGray;}", self.response.content)
        self.assertIn(u"grade_D {color:DarkSlateGray;}", self.response.content)
