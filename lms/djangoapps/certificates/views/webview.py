...
def _update_certificate_context(context, course, user_certificate, platform_name):
    ...
    context[u'document_title'] = _(u"{partner_short_name} {course_number} Certificate | {platform_name}").format(
        partner_short_name=context['organization_short_name'],
        course_number=context['course_number'],
        platform_name=platform_name
    )
...
def _update_context_with_basic_info(context, course_id, platform_name, configuration):
    ...
    context[u'certificate_verify_title'] = _(u"How {platform_name} Validates Student Certificates").format(
        platform_name=platform_name
    )
    ...
    context[u'company_about_description'] = _(u"{platform_name} offers interactive online classes and MOOCs.").format(
        platform_name=platform_name)

    context[u'company_about_title'] = _(u"About {platform_name}").format(platform_name=platform_name)

    context[u'company_about_urltext'] = _(u"Learn more about {platform_name}").format(platform_name=platform_name)

    context[u'company_courselist_urltext'] = _(u"Learn with {platform_name}").format(platform_name=platform_name)

    context[u'company_careers_urltext'] = _(u"Work at {platform_name}").format(platform_name=platform_name)

    context[u'company_contact_urltext'] = _(u"Contact {platform_name}").format(platform_name=platform_name)

    # Translators:  This text appears near the top of the certficate and describes the guarantee provided by edX
    context[u'document_banner'] = _(u"{platform_name} acknowledges the following student accomplishment").format(
        platform_name=platform_name
    )
...
def _update_context_with_user_info(context, user, user_certificate):
    ...
    context[u'accomplishment_banner_opening'] = _(u"{fullname}, you earned a certificate!").format(
