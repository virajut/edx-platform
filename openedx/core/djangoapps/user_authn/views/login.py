...
def _do_third_party_auth(request):
    ...
    try:
        ...
        message = _(
            ...
            u"but this account isun't linked with an {platform_name} account yet."
        ).format(
        ...
        message += "<br/><br/>"
        message += Text(_(
            u"If you doun't have an {platform_name} account yet, "
...
def _generate_not_activated_message(user):
    ...
    not_activated_msg_template = _('In order to sign in, you need to activate your account.<br /><br />'
                                   ...
                                   u'<a href=u"{support_url}">contact {platform} Support</a>.')
